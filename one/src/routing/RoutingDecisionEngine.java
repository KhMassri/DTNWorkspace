...
public interface RoutingDecisionEngine
{
	 ...
	 */
	public boolean shouldSendMessageToHost(Message m, DTNHost me, DTNHost otherNode);
	...
	/**
	 * Called when a getOldestMessage is needed to make room for new incoming
	 * to decide whether a Queue management (sorting) technique is used or not
	 * @return true if there is a sorting scheme used. false otherwise (messages are dropped according to receive time)
	 */
