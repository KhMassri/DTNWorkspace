...
public abstract class MessageRouter {
	...
	protected static final int DENIED_DELIVERED = -4;
	...
	/**list of the sink addresses */
	private List<DTNHost> sinkAddresses;
	/** size of the buffer */
	...
	public Message messageTransferred(String id, DTNHost from) {
		...
		isFinalRecipient = (aMessage.getTo() == this.host)||
				(this.isSink()&& aMessage.getTo().isSink());
	...
	public boolean isSink(){
		...
		return sinkAddresses.contains(this.getHost());
	...
	public boolean createNewMessage(Message m) {
		...
		/* 
		 * Don't tell listeners about messages from generators
		 */
		boolean newMessage =getHost().getRouter().hello().equals("GeneratorRouter");
	...
	public void setSinkAddresses(List<DTNHost> sinkAddresses2){
				
		this.sinkAddresses=sinkAddresses2;
			
	}
	
	public DTNHost getASink(){
		
		return sinkAddresses.get(0);
	}
	/** 
...
/*
	...
	public RoutingDecisionEngine getDecider(){return decider;
	}
