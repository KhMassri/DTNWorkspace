 ...
 */
public class FirstContactToSink extends DTNRouter {
	 ...
	 */
	public FirstContactToSink(Settings s) {
		super(s);
	}
	 ...
	 */
	protected FirstContactToSink(FirstContactToSink r) {
		super(r);
	}
	...
	public MessageRouter replicate() {
		return new FirstContactToSink(this);
	}
