 ...
 */
public class SprayAndFocus extends DTNRouter 
{
	/** SprayAndFocus router's settings name space ({@value})*/ 
	public static final String SPRAYANDFOCUS_NS = "SprayAndFocus";
	...
	public SprayAndFocus(Settings s)
	{
		super(s);
	 ...
	 */
	public SprayAndFocus(SprayAndFocus r)
	{
		super(r);
