...
public abstract class Report {
	...
	/*
	 * Return the avg of a map
	 */
	public String getAverage(Map<String, Double> msgCustodianTime) {

		double sum = 0;
		if(msgCustodianTime.size() == 0)
			return NAN;
		
		for(Entry<String,Double> e : msgCustodianTime.entrySet())
			sum += e.getValue();
				
				return format(sum/msgCustodianTime.size());
	}
